...
import pf_art_im from '../images/info/pf-art-im.jpg'
    ...
    return (
        <div id="main_container">
            <div class="side left">
                ...
                <p className="default">
                    Fora a área da técnologia, como hobbie estudo manipulação de imagens no Photoshop e vetores no Illustrator. Além disso, utilizo o photoshop para diversas trabalhos como a confecção de banners.
                    <img src={flower_art_im}></img>
                    <img src={pf_art_im}></img>
                </p>
                <p className="default">
                    Além de desenho técnico em escala 2D e 3D no AutoCAD.
