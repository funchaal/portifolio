    ...
    return (
        <div id="main_container" onMouseMove={mouseMv} onMouseOut={mouseOt}>
          <div className="side left" style={{ height: '100vh', justifyContent: 'center', alignItems: 'center', padding: 0, marginLeft: '50px' }}>
            ...
            <div className="more">
              <p>Olá, meu nome é Rafael, tenho 16 anos, sou formado em Técnico em Comércio Exterior e sou apaixonado em programação e ciência de dados. Iniciei na programação aos 11 anos de idade. Hoje, me especializo em javascript e React para desenvolvimento web full-stack e em python para ciência de dados e machine learning.</p>
              <p className="hide">Devido à enorme experiencia na área da computação que obtive por estudar a área desde pequeno e por ter feito diversos cursos relacionados, também acumulei conhecimentos consolidados em Excel, vba, banco de dados, machine learning, dentre outros. Este portifólio foi criado por mim como uma forma de detalhar meu perfil profissional além do currículo, então basta navegar!</p>
